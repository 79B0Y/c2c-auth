...
%% 4) Actix
subgraph AC[4) Actix]
  Fulfill[Fulfillment: SYNC / QUERY / EXECUTE / Discovery / Control]
  Auth[JWT 验签 / iss-aud-kid 校验]
  Idem[幂等 / 限流 / 超时]
...
subgraph NEW[7) 需开发程序]
  LocalJS[llk-localhome-app (local_app.js)]
  Adapter[llk-edge-adapter (设备协议桥)]
  DevSvc[llk-device-service (设备/状态服务)]
end
